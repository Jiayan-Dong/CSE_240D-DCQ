...
# W32
python3 dcq.py -a svhn --lr 0.01 -p 50 -b 128 ./data/data.svhn/ -j 8 --epochs 20 --wd=0.0002 --vs=0 --gpus 0 --out-dir="logs/svhn_w32/" --compress=./quantization/svhn_dorefa_w32.yaml --resume=./logs/svhn_float/{}/best.pth.tar
# W1
python3 dcq.py -a svhn --lr 0.01 -p 50 -b 128 ./data/data.svhn/ -j 8 --epochs 20 --wd=0.0002 --vs=0 --gpus 0 --out-dir="logs/svhn_w1/" --compress=./quantization/svhn_dorefa_w1.yaml --resume=./logs/svhn_w32/{}/best.pth.tar

# W1_DCQ_Stage1
python3 svhn_partial.py -a svhn --lr 0.01 -p 50 -b 128 ./data/data.svhn/ -j 8 --epochs 20 --wd=0.0002 --vs=0 --gpus 0 --out-dir="logs/svhn_w1_dcq_s1/" --compress=./quantization/svhn_dorefa_w1.yaml --resume=./logs/svhn_w32/{}/best.pth.tar --fpcompress=./quantization/svhn_dorefa_w32.yaml --fpresume=./logs/svhn_w32/{}/best.pth.tar
# W1_DCQ_Stage2
python3 svhn_partial_2.py -a svhn --lr 0.01 -p 50 -b 128 ./data/data.svhn/ -j 8 --epochs 20 --wd=0.0002 --vs=0 --gpus 0 --out-dir="logs/svhn_w1_dcq_s2/" --compress=./quantization/svhn_dorefa_w1.yaml --resume=./logs/svhn_w1_dcq_s1/{}/checkpoint.pth.tar --fpcompress=./quantization/svhn_dorefa_w32.yaml --fpresume=./logs/svhn_w32/{}/best.pth.tar

# Fine Tun
python3 fine_tune.py -a svhn --lr 0.01 -p 50 -b 128 ./data/data.svhn/ -j 8 --epochs 20 --wd=0.0002 --vs=0 --gpus 0 --out-dir="logs/svhn_w1_dcq_fine_tune/" --compress=./quantization/svhn_dorefa_w1.yaml --resume=./logs/svhn_w1_dcq_s2/{}/best.pth.tar --fpcompress=./quantization/svhn_dorefa_w32.yaml --fpresume=./logs/svhn_w32/{}/best.pth.tar
